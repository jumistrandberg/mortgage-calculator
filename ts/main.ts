...
class LoanCalculator {
  ...
  constructor() {
    ...
    this.interestInput = document.getElementById(
      "interest"
    ) as HTMLInputElement;
  ...
  private displayValues(values: LoanValues[], inputValues: InputValues) {
    ...
    values.forEach((value, index) => {
      ...
      amountLeftDiv.textContent = `Återstående belopp: ${value.amountLeft.toFixed(
        0
      )}`;
    ...
    this.outputContainer.insertBefore(
      hideShowBtn,
